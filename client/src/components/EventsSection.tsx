...
const events: Event[] = [
  {
    ...
    month: "APR",
    day: "9",
    title: "Jericho End-of-Year Celebration",
    description: "Enjoy lots of food, great fellowship, and games as we celebrate another great year for Jericho Hall! 4:00 PM",
    type: "social",
    location: "📍 Ghormley Park",
  },
];
